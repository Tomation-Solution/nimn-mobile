...
import { org_name, RequestCall } from '../../../connection/actions/user.actions'
...
const GeneralSingle = ({navigation,route}) => {
    ...
    var ws = new WebSocket(`wss://rel8-backend-production.up.railway.app/ws/commitee_chat/${org_name}/${commitee.id}/`)
